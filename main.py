...
CHARACTERS = {
    ...
    "jaemin": {
        "name": "재민",
        "image": "images/jaemin.jpg",
        "desc": "23년도의 재림.",
    },
    "sungmin": {
        "name": "성민",
        "image": "images/sungmin.jpg",
        "desc": "세계제일의 검사가 되는 그날까지.",
    },
    "jungwoo": {
        "name": "정우",
        "image": "images/jungwoo.png",
        "desc": "소의 친구.",
    },
    "suin": {
        "name": "수인",
...
CHARACTER_SKILL_GUIDES = {
    "beminje": [
        ...
        "재간둥이: 523연속 재간둥이.",
        "착지 충격: 재간둥이 종료 시 주변 적에게 피해를 줍니다.",
    ],
    "jaemin": [
        "오오라: 주변으로 그의 아우라가 펼쳐집니다.",
        "각성재민: 각성재민을 막을수 있는건 없습니다.",
        "맵 오오라: 23년도의 재림이군요......",
    ],
    "sungmin": [
        "조준 참격: 세계제일의 검사가 되기위한 첫번째길.",
        "달빛가르기: 선천적인 재능이란 무엇인가.",
        "검 장착: 우리는 왜 수련을 해야하는 것인가.",
    ],
    "jungwoo": [
        "소 돌진: 정우가 친구를 부릅니다.",
        "소떼 돌진: 파티군요.",
    ...
    "iinrok2": [
        ...
        "회복 아이템: 3가지의 회복아이템을 확률적으로 사용합니다.",
        "회복량: 에너지드링크 < 붕대 < 구급상자 순서입니다..",
    ],
    "gyeongsik": [
        "해물찜 투척: 상대에게 해물찜과 온기를 선물합니다.",
        "열기 장판: 온기가 남아있는 바닥입니다.",
        "해물찜 폭격: 재앙이 시작됩니다.",
    ],
    "geonwoo": [
        "no information."
